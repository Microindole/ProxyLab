"""VLESS composition renderers targeting Xray-core."""
...
def render_vless_reality_vision_server(
    ...
    *,
    ...
    """Render VLESS RAW with REALITY and Vision using Xray-core."""
    validate_port(port)
    ...
    return {
        ...
        "inbounds": [
            {
                "tag": "vless-raw-reality-vision-in",
                "listen": "0.0.0.0",
                "port": port,
                "protocol": "vless",
                "settings": {
